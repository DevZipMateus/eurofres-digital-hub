        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            {contactInfo.map((info, index) => (
              <div 
                key={index}
                className="bg-card border border-border rounded-xl p-8 hover:shadow-lg transition-all animate-fade-up"
          ...
          <div className="bg-gradient-to-br from-primary to-primary/90 rounded-2xl p-8 md:p-12 text-center animate-fade-up">
          ...
          <div className="mt-12 text-center animate-fade-up">
            ...
            <div className="flex justify-center gap-4">
              <a
                ...
                className="w-12 h-12 bg-card border border-border rounded-full flex items-center justify-center hover:bg-accent/10 hover:border-accent transition-all"
